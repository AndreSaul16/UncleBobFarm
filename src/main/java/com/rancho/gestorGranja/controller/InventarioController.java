...
import com.rancho.gestorGranja.dto.InventarioDTO;
...
public class InventarioController {
    ...
    @GetMapping
    public List<InventarioDTO> getAllItems() {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<InventarioDTO> getItemById(@PathVariable Long id) {
        return inventarioService.findById(id)
                .map(inventario -> ResponseEntity.ok(new InventarioDTO(inventario)))
    ...
    public ResponseEntity<?> createItem(@RequestBody Inventario item) {
        try {
            ...
            return ResponseEntity.ok(new InventarioDTO(nuevoItem));
        } catch (Exception e) {
    ...
    public ResponseEntity<?> updateItem(@PathVariable Long id, @RequestBody Inventario itemDetails) {
        try {
            ...
            return ResponseEntity.ok(new InventarioDTO(itemActualizado));
        } catch (Exception e) {
